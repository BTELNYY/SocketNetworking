...
$cert = New-SelfSignedCertificate -Type Custom -Subject "localhost" -DnsName "localhost" -KeyAlgorithm RSA -KeyLength 2048 -KeyExportPolicy Exportable -CertStoreLocation "Cert:\CurrentUser\My"
